...
guint predef_colors_rgba[COLOR_MAX] = {
  0x000000ff,	0xa2e9d8ff,	0x00cba3ff,	0xffbcbbff,
0xff5668ff,	0x8fc0d1ff,	0x487f9cff,	0xffe38dff,
0xef8700ff,	0x5c5c5cff,	0xffffffff
};
...
double predef_thickness[NUM_STROKE_TOOLS][THICKNESS_MAX] =
  { { 0.85, 1.41,  3.26, 5.67, 8.51 }, // pen thicknesses = 0.15, 0.3, 0.5, 0.8, 2 mm
    { 2.83, 2.83, 8.50, 19.84, 19.84 }, // eraser thicknesses = 1, 3, 7 mm
    { 2.83, 4.83, 8.50, 14.84, 19.84 }, // highlighter thicknesses = 1, 3, 7 mm
  };
